...
public class LogPatternConstants {
	...
	/**
	 * Log pattern constant for Database invalid data access resource usage error.
	 */
	...
	/**
	 * Log pattern constant for application name for Payment Methods Fund Service.
	 */
	...
	/**
	 * Log pattern constant for API Payment Methods Service - Fetch Payment Methods
	 * by CN
	 */
	...
	/**
	 * Log pattern constant for method Payment Methods Fund Service - fetch funds by
	 * CN.
	 */
	...
	/**
	 * Log pattern constant for invoice processing scheduler job completion event
	 */
	...
	/**
	 * Log pattern constant for count of technical failures occurred during retry
	 * scheduling job run.
	 */
	...
	/**
	 * Log pattern constant for count of invoices skipped during retry scheduling
	 * job run
	 */
	...
	/**
	 * Log pattern constant for datacentre in which payment invoice was orginally
	 * consumed.
	 */
	...
	/**
	 * Trace Log level to store for internal logs
	 */
	public static final String LOG_LEVELS_FOR_TRACE = "TRACE,DEBUG,INFO,WARN,ERROR,FATAL";

	/**
	 * Debug Log level to store for internal logs
	 */
	public static final String LOG_LEVELS_FOR_DEBUG = "DEBUG,INFO,WARN,ERROR,FATAL";

	/**
	 * Info Log level to store for internal logs
	 */
	public static final String LOG_LEVELS_FOR_INFO = "INFO,WARN,ERROR,FATAL";

	/**
	 * Warn Log level to store for internal logs
	 */
	public static final String LOG_LEVELS_FOR_WARN = "WARN,ERROR,FATAL";

	/**
	 * Error Log level to store for internal logs
	 */
	public static final String LOG_LEVELS_FOR_ERROR = "ERROR,FATAL";

	/**
	 * FATAL Log level to store for internal logs
	 */
	public static final String LOG_LEVELS_FOR_FATAL = "FATAL";
	
	/**
	 * Default Log level to store for internal logs
	 */
	public static final String DEFAULT_LOG_LEVELS = "WARN,ERROR,FATAL";
